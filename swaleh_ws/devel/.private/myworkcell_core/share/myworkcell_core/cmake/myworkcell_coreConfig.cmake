...
if("TRUE" STREQUAL "TRUE")
  set(myworkcell_core_SOURCE_PREFIX /home/mso797/Desktop/TII/INTERVIEW_ASSIGNMENT/tii_interview_docker/swaleh_ws/src/myworkcell_core)
  set(myworkcell_core_DEVEL_PREFIX /home/mso797/Desktop/TII/INTERVIEW_ASSIGNMENT/tii_interview_docker/swaleh_ws/devel/.private/myworkcell_core)
  ...
  set(myworkcell_core_INSTALL_PREFIX /home/mso797/Desktop/TII/INTERVIEW_ASSIGNMENT/tii_interview_docker/swaleh_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'myworkcell_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mso797/Desktop/TII/INTERVIEW_ASSIGNMENT/tii_interview_docker/swaleh_ws/src/myworkcell_core/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT myworkcell_core_NUM_DUMMY_TARGETS)
      set(myworkcell_core_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::myworkcell_core::wrapped-linker-option${myworkcell_core_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR myworkcell_core_NUM_DUMMY_TARGETS "${myworkcell_core_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::myworkcell_core::wrapped-linker-option${myworkcell_core_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND myworkcell_core_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mso797/Desktop/TII/INTERVIEW_ASSIGNMENT/tii_interview_docker/swaleh_ws/devel/.private/myworkcell_core/lib;/home/mso797/Desktop/TII/INTERVIEW_ASSIGNMENT/tii_interview_docker/swaleh_ws/devel/lib;/opt/ros/melodic/lib)
